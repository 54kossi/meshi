...
"一休"=>["桜","ラーメン","なし"],
"小五郎"=>["桜","ラーメン","月"],
"麺 the Tokyo"=>["天3","ラーメン","日"],
"松乃家"=>["桜","うなぎ","月、火"],
"松のや"=>["天4","とんかつ","なし"],
"はりけんラーメン"=>["栗原","ラーメン","月"],
"油虎"=>["筑穂","油そば","なし"],
"丸長"=>["春4","つけ麺","水"],
"サイゼリヤ"=>["吾妻1(Q't内)","ファミレス","なし"],
"デニーズ"=>["春2","ファミレス","なし"],
"ココス"=>["天2、桜","ファミレス","なし"],
"ガスト"=>["天2、桜","ファミレス","なし"],
"ジョイフル"=>["桜","ファミレス","なし"],
...
"Roots"=>["吾妻3","ラーメン","月、火"],
"松屋食堂"=>["天1","ラーメン",""],
"三水"=>["上横場(割と離れてる)","ラーメン","なし"],
"逆流"=>["小田(めっちゃ遠い)","ラーメン","月"],
"角ふじ"=>["上横場(割と離れてる)","ラーメン","火"],
"天下一品"=>["花室","ラーメン","なし"],
"鬼物語"=>["榎戸(自転車で行く距離じゃない)","ラーメン",""],
"いっとく"=>["刈間","ラーメン","なし"],
"喜元門"=>["研究学園","ラーメン","なし"],
"イチカワ"=>["天2","ラーメン","水、日"],
"幸楽苑"=>["小野崎、イーアス","ラーメン","なし"],
"レッチリ"=>["研究学園","ラーメン","日"],
"ららららーめんや"=>["天1","ラーメン",""],
"大成軒"=>["天1","中華料理","金"],
"百香亭"=>["天3、東平塚","中華料理","なし"],
...
"えん弥"=>["桜","中華料理","なし"],
"笑飯店"=>["桜","中華料理","なし"],
"CASA NOVA"=>["天2","イタリアン","なし"],
"ハンアリ"=>["天2","韓国焼き肉レストラン","月"],
"豊しん"=>["天2","海鮮料理","木"],
"KURA"=>["天2","","なし"],
"薔薇絵亭"=>["天2","洋食レストラン","なし"],
"一太郎"=>["天2","お好み焼き",""],
...
"とよ助"=>["天1","焼き鳥、居酒屋","火"],
"すた丼"=>["天2","定食屋","なし"],
"フライング・ガーデン"=>["西平塚","レストラン","なし"],
"益さん"=>["天3","定食屋","なし"],
"ウエストハウス"=>["西平塚","レストラン","なし"],
"くい亭"=>["上野(桜の奥の方)","レストラン","土、日"],
"おかんの飯"=>["天3","定食屋","火、木、土、日"],
"李飯店"=>["春3","中華料理",""],
"とどろき"=>["花畑","ラーメン","月"],
"がむしゃ"=>["筑穂","ラーメン","日"],
"ドルフ"=>["天3","カフェレストラン","日"],
"アリーズ・ケバブ"=>["天2","レストラン","なし"]}
hash.update(list)
#ラーメン屋の店名だけ
...
"喜元門","イチカワ","幸楽苑","レッチリ","ららららーめんや","丸源","大元","とどろき","がむしゃ","幸楽苑"].uniq
#牛丼チェーン店の店名だけ
gyudonya=["松屋","吉野家","すき家"]
#ハッシュのキーから飯屋の名前取得して配列に
...
jikanwari2=["こっしーじかんわり","こっしー時間割","jknwr","zknwr","じかんわり","時間割"]
kositan=["こしたん","こしたそ"]
kosimeshi=["飯","めし","メシ"]
kosiramen=["ラーメン","らーめん"]
kositangoi=["こしたんじゃないよう...","や、ぼきはこしたんではないでつね","こしたんではないけど...","こしたんではないんだけども(´・ω・`)","こしあんおいしいよね"]
